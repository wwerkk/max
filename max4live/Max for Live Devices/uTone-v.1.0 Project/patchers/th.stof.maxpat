...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 83.0, 435.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 118.0, 435.0, 48.0 ],
					"text" : "Convert a number from scala scale-format to the corresponding frequency based on the set tune and center value. Use this object in combination with the th.scala to load your desired .scl file.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 30.0, 435.0, 52.0 ],
					"text" : "th.stof",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 390.0, 80.0, 22.0 ],
					"text" : "---_sclDefault"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 234.0, 270.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 247.0, 495.0, 66.0, 22.0 ],
					"text" : "listfunnel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 344.0, 420.0, 55.0, 22.0 ],
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 330.0, 57.0, 22.0 ],
					"text" : "t b l clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 247.0, 465.0, 75.0, 22.0 ],
					"text" : "zl 512 group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 247.0, 525.0, 116.0, 22.0 ],
					"text" : "peek~ ---_sclDefault"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 285.0, 563.0, 195.0, 22.0 ],
					"text" : "buffer~ ---_sclDefault @samps 512"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 266.0, 390.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 360.0, 47.0, 22.0 ],
					"text" : "dict.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.75, 270.0, 29.5, 22.0 ],
					"text" : "$1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 345.0, 91.0, 22.0 ],
					"text" : "sprintf %s_data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 435.0, 84.0, 22.0 ],
					"text" : "prepend scala"
				}
...
,
					"patching_rect" : [ 93.0, 510.0, 117.0, 22.0 ],
					"text" : "gen @t toFrequency"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 234.0, 240.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					...
					"patching_rect" : [ 247.0, 300.0, 165.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 125.75, 240.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 570.0, 30.0, 30.0 ]
				}
